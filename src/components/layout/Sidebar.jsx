      ...
      <div className="member-list" style={{ marginTop: '20px', flex: 1, overflowY: 'auto', paddingRight: '4px' }}>
        ...
        .sort(([groupA], [groupB]) => {
          if (groupBy === 'joinDate') {
            ...
            return groupB.localeCompare(groupA); // 新しい年度を上に
          } else {
                ...
                return (
                  <div 
                    ...
                    style={{
                      ...
                      cursor: 'pointer',
                      display: 'flex',
                      flexDirection: 'column', // 3列の場合は縦並びの方が視認性が良い
                      alignItems: 'center',
                      gap: '4px',
                  ...
                  >
                    <img 
                      src={member.photo} 
                      alt="" 
                      style={{ width: '28px', height: '28px', borderRadius: '50%', border: `1.5px solid ${roleColor}`, flexShrink: 0 }} 
                    />
                    <div style={{ textAlign: 'center', width: '100%', minWidth: 0 }}>
                      ...
                      <div style={{ 
                        fontSize: '0.6rem', 
                        color: roleColor, // 役職の色を適用
                        fontWeight: '700', // 少し太くして見やすく
                        whiteSpace: 'nowrap',
                        overflow: 'hidden',
                        textOverflow: 'ellipsis'
                      }}>
